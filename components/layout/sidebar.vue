    ...
    <div class="h-full bg-gray-50 dark:bg-gray-800">
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center space-x-2">
                ...
                <span class="text-lg font-semibold text-gray-900 dark:text-white">Dokümantasyon</span>
            </div>
        </div>
        ...
        <div class="p-4">
            <!-- Ana Sayfa -->
            <div class="mb-6">
                <h3 class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">Ana Menü</h3>
                <ul class="space-y-1">
                    <li>
                        <NuxtLink 
                            to="/" 
